...
const routes = [
    ...
    { path: 'actualites', loadComponent: () => import('./pages/actualites/actualites.component').then(m => m.ActualitesComponent) },
    {
        ...
        loadComponent: () => import('./pages/articles/marathon-biblique/marathon-biblique.component')
            .then(m => m.MarathonBibliqueComponent),
    },
    {
        path: 'actualites/voeux-2026-pasteur-fernand',
        loadComponent: () => import('./pages/articles/voeux2026-pasteur-fernand/voeux2026-pasteur-fernand.component')
...
AppRoutingModule.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({ imports: [RouterModule.forRoot(routes, {
